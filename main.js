...
for (let i = 0; i < botoes.length; i++) {
    ...
    // ao clicar ele remove a classe .ativa
}

const contadores = document.querySelectorAll(".contador");
const tempoObjetivo1 = new Date("2025-12-05T00:00:00");
const tempoObjetivo2 = new Date("2025-10-30T00:00:00");
const tempoObjetivo3 = new Date("2025-10-16T00:00:00");
const tempoObjetivo4 = new Date("2028-06-12T00:00:00");
//tempo do cronometro das metas 

const tempos = [tempoObjetivo1, tempoObjetivo2, tempoObjetivo3, tempoObjetivo4];

//listas dos objetivos (simbolo {})
...
function calculaTempo(tempoObjetivo) {
    ...
    //calculo de arrendondamento das variaveis de tempo
